...
export function PlaneSprite({
  ...
  return (
    <div className={`relative ${className}`} style={{ aspectRatio: "150 / 74" }}>
      <svg
        viewBox="0 0 150 74"
        role="img"
      ...
      >
        {/* Full official propeller (upper + lower blades and hub). */}
        <g
          style={{
            transformOrigin: "135.55px 36.95px",
            animation: spinning ? "aviator-prop-flicker 0.025s steps(1, end) infinite" : undefined,
